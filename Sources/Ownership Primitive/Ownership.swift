...
/// | ``Immutable`` | Shared (ARC) | Immutable | When `Value: Sendable` |
...
/// - Need shared immutable heap storage? → ``Immutable``
...
///
/// ### Immutable shared
/// - `Immutable`: Sendable when `Value: Sendable` (immutable, safe to share)
///
